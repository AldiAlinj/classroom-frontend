...
const ClassesShow = () => {
  ...
  if (isLoading || isError || !classDetails || classDetails?.length === 0) {
    return (
  ...
  return (
    <ShowView className="show-view class-show">
      <ShowViewHeader resource="classes" title="Class Details" />
      ...
      <Card className="details-card">
        ...
        <div className="join">
            <h2>Join Class</h2>
            <ol>
                <li>Ask your teacher for your invite code</li>
